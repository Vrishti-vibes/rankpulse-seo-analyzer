...
Returns the structured SEO report for the analyzed website.
...
* No Woorank APIs are used.
* No paid SEO APIs are used.
* The scoring model is custom-built.
* The analyzer uses backend-measurable SEO and performance signals.
* Lighthouse/Core Web Vitals integration is listed as a future improvement because it requires browser-level execution.

## Developer

Kumari Vrishti
B.Tech Computer Science Engineering
Vishveshwarya Group of Institutions, AKTU
